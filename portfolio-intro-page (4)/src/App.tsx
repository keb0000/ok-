...
const DEFAULT_PORTRAIT = "/kimeunbin_portrait_1781527351351.jpg";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (savedPortrait) {
      if (!isPortraitValid(savedPortrait) || savedPortrait.includes("/src/assets/") || savedPortrait.includes("kimeunbin_portrait")) {
          ...
          {portfolioView === "cover" && (
            ...
            >
              ...
              >
                ...
                >
                  <img 
                    src={isPortraitValid(customPortrait) ? customPortrait : DEFAULT_PORTRAIT} 
                    alt="Kimeunbin's Portrait" 
                    referrerPolicy="no-referrer"
                    className="w-full h-full object-cover select-none pointer-events-none"
                    onError={(e) => {
                      console.error("Portrait image load failed, falling back to default.");
                      if (customPortrait) {
                        localStorage.removeItem("kimeunbin_custom_portrait");
                        setCustomPortrait(null);
                      }
